...
{
    private final Collection<DynamicRecord> dynamicRecords;

    public SkipListStoreLoadedRecord( long id, K key, V value, long[] nexts, Collection<DynamicRecord> dynamicRecords )
    {
    ...
    public SkipListStoreLoadedRecord( long[] nexts, Collection<DynamicRecord> dynRecords )
    {
        ...
        this.dynamicRecords = dynRecords;
    }
