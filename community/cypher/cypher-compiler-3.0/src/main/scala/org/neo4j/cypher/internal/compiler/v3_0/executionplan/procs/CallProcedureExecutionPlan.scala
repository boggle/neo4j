...
import org.neo4j.cypher.internal.frontend.v3_0.ast.{Variable, Expression}
...
/**
  ...
  */
case class CallProcedureExecutionPlan(signature: ProcedureSignature, argExprs: Seq[Expression], resultIndices: Seq[(Int, String)])
