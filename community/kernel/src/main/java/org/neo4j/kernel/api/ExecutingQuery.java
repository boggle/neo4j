...
public class ExecutingQuery
{
    ...
    private final QuerySourceDescriptor querySource;
    ...
    public ExecutingQuery(
        long queryId,
        QuerySourceDescriptor querySource,
        String username,
        String queryText,
    ...
    public QuerySourceDescriptor querySource()
    {
        return querySource;
    }
    ...
    {
        return format(
            "ExecutingQuery{queryId=%d, querySource='%s', username='%s', queryText='%s', queryParameters=%s, startTime=%d}",
