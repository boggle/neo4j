...
abstract class RowOperator[P <: Pos[P], C <: Cursor[P, C], E](key: AnyRef, dest: Operator[P, C, E])
  extends ChainingOperator[P, C, E](key, dest) {

  override def newActivation(pool: RowPool[P, C], scheduler: Scheduler[P, C, E]): RowActivation[P, C, E]
}
